...
class ResPartner(models.Model):
    ...
    partner_company_type_id = fields.Many2one(
        comodel_name="res.partner.company.type", string="Legal Entity Type"
    )
        ...
        for rec in self:
            ...
            if (
                ...
                raise ValidationError(
                    _(
                        "You must select a Legal Entity Type from the country "
            ...
            if (
                ...
                raise ValidationError(
                    _(
                        "You must select a Legal Entity Type from the state "
                        "of the partner address."
                    )
                )
