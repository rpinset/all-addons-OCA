...
class ClusterPickingSetDestinationAllCase(ClusterPickingUnloadingCommonCase):
    ...
    def test_set_destination_all_remaining_lines(self):
        ...
        # (That should not matter since by default the order is based on the move line
        # id, and the two lines picking has a lower id than the one line picking,
