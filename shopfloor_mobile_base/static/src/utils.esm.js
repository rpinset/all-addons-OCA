 ...
 */
import {utils_registry} from "./services/utils_registry.esm.js";
...
export class DisplayUtils {
    ...
    format_date_display(date_string, options = {}, utc = true) {
        let ds = date_string;
        if (utc) {
            ds = this._ensure_UTC_datetime(ds);
        }
        _.defaults(options, {
        ...
        return new Date(Date.parse(ds)).toLocaleString(options.locale, options.format);
    }
