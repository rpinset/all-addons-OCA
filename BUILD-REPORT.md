...
| Repo | Reason | Detail |
| ---- | ------ | ------ |
| [.github](https://github.com/OCA/.github) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
...
| [ansible-odoo](https://github.com/OCA/ansible-odoo) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [apps-store](https://github.com/OCA/apps-store) | `no_module` | No directory with __manifest__.py at repo root |
| [bank-payment-alternative](https://github.com/OCA/bank-payment-alternative) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
...
| [connector-magento-php-extension](https://github.com/OCA/connector-magento-php-extension) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
...
| [connector-shopify](https://github.com/OCA/connector-shopify) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
...
| [l10n-australia](https://github.com/OCA/l10n-australia) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
...
| [maintainer-tools](https://github.com/OCA/maintainer-tools) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [mass-mailing](https://github.com/OCA/mass-mailing) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [mirrors-flake8](https://github.com/OCA/mirrors-flake8) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
...
| [oca-addons-repo-template](https://github.com/OCA/oca-addons-repo-template) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [oca-apps-store](https://github.com/OCA/oca-apps-store) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [oca-ci](https://github.com/OCA/oca-ci) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [oca-custom](https://github.com/OCA/oca-custom) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [oca-github-bot](https://github.com/OCA/oca-github-bot) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [oca-port](https://github.com/OCA/oca-port) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [oca-weblate-deployment](https://github.com/OCA/oca-weblate-deployment) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [oca.recipe.odoo](https://github.com/OCA/oca.recipe.odoo) | `no_module` | No directory with __manifest__.py at repo root |
| [odoo-community.org](https://github.com/OCA/odoo-community.org) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [odoo-module-migrator](https://github.com/OCA/odoo-module-migrator) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [odoo-pim](https://github.com/OCA/odoo-pim) | `no_module` | No directory with __manifest__.py at repo root |
| [odoo-pre-commit-hooks](https://github.com/OCA/odoo-pre-commit-hooks) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [odoo-sentinel](https://github.com/OCA/odoo-sentinel) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [odoo-sphinx-autodoc](https://github.com/OCA/odoo-sphinx-autodoc) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [odoo-test-helper](https://github.com/OCA/odoo-test-helper) | `no_module` | No directory with __manifest__.py at repo root |
| [odoorpc](https://github.com/OCA/odoorpc) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [openupgradelib](https://github.com/OCA/openupgradelib) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
...
| [py3o.template](https://github.com/OCA/py3o.template) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [pylint-odoo](https://github.com/OCA/pylint-odoo) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [pytest-odoo](https://github.com/OCA/pytest-odoo) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [repo-maintainer](https://github.com/OCA/repo-maintainer) | `no_module` | No directory with __manifest__.py at repo root |
| [repo-maintainer-conf](https://github.com/OCA/repo-maintainer-conf) | `no_module` | No directory with __manifest__.py at repo root |
...
| [stock-logistics-shopfloor](https://github.com/OCA/stock-logistics-shopfloor) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
...
| [tier-validation](https://github.com/OCA/tier-validation) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
| [version-control-platform](https://github.com/OCA/version-control-platform) | `no_branch` | fatal: Remote branch 17.0 not found in upstream origin |
