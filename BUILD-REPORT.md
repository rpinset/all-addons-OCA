...
| Repo | Reason | Detail |
| ---- | ------ | ------ |
| [.github](https://github.com/OCA/.github) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [agreement](https://github.com/OCA/agreement) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [ai](https://github.com/OCA/ai) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [connector-shopify](https://github.com/OCA/connector-shopify) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [cooperative](https://github.com/OCA/cooperative) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [crowdfunding](https://github.com/OCA/crowdfunding) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [department](https://github.com/OCA/department) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [dotnet](https://github.com/OCA/dotnet) | `no_module` | No directory with __manifest__.py at repo root |
| [e-learning](https://github.com/OCA/e-learning) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [edi-ediversa](https://github.com/OCA/edi-ediversa) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [edi-framework](https://github.com/OCA/edi-framework) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [edi-voxel](https://github.com/OCA/edi-voxel) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [l10n-australia](https://github.com/OCA/l10n-australia) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [l10n-bulgaria](https://github.com/OCA/l10n-bulgaria) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [l10n-cambodia](https://github.com/OCA/l10n-cambodia) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [l10n-macedonia](https://github.com/OCA/l10n-macedonia) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [l10n-paraguay](https://github.com/OCA/l10n-paraguay) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [l10n-russia](https://github.com/OCA/l10n-russia) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [l10n-slovenia](https://github.com/OCA/l10n-slovenia) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [mail](https://github.com/OCA/mail) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [maintainer-tools](https://github.com/OCA/maintainer-tools) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [mass-mailing](https://github.com/OCA/mass-mailing) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [mirrors-flake8](https://github.com/OCA/mirrors-flake8) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [module-composition-analysis](https://github.com/OCA/module-composition-analysis) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [oca-addons-repo-template](https://github.com/OCA/oca-addons-repo-template) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [oca-apps-store](https://github.com/OCA/oca-apps-store) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [oca-ci](https://github.com/OCA/oca-ci) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [oca-github-bot](https://github.com/OCA/oca-github-bot) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [oca-port](https://github.com/OCA/oca-port) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [oca-weblate-deployment](https://github.com/OCA/oca-weblate-deployment) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [oca.recipe.odoo](https://github.com/OCA/oca.recipe.odoo) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [odoo-community.org](https://github.com/OCA/odoo-community.org) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [odoo-module-migrator](https://github.com/OCA/odoo-module-migrator) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [odoo-pre-commit-hooks](https://github.com/OCA/odoo-pre-commit-hooks) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [odoo-sentinel](https://github.com/OCA/odoo-sentinel) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [odoo-sphinx-autodoc](https://github.com/OCA/odoo-sphinx-autodoc) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [odoo-test-helper](https://github.com/OCA/odoo-test-helper) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [odoorpc](https://github.com/OCA/odoorpc) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [openupgradelib](https://github.com/OCA/openupgradelib) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [pms](https://github.com/OCA/pms) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [product-configurator](https://github.com/OCA/product-configurator) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [product-kitting](https://github.com/OCA/product-kitting) | `no_module` | No directory with __manifest__.py at repo root |
| [program](https://github.com/OCA/program) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [stock-logistics-request](https://github.com/OCA/stock-logistics-request) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [vertical-cooperative-supermarket](https://github.com/OCA/vertical-cooperative-supermarket) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
...
| [vertical-medical](https://github.com/OCA/vertical-medical) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [vertical-ngo](https://github.com/OCA/vertical-ngo) | `no_module` | No directory with __manifest__.py at repo root |
| [vertical-rental](https://github.com/OCA/vertical-rental) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [vertical-travel](https://github.com/OCA/vertical-travel) | `no_module` | No directory with __manifest__.py at repo root |
| [wallet](https://github.com/OCA/wallet) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
| [web-api](https://github.com/OCA/web-api) | `no_module` | No directory with __manifest__.py at repo root |
| [web-api-contrib](https://github.com/OCA/web-api-contrib) | `no_branch` | fatal: Remote branch 13.0 not found in upstream origin |
