...
| Repo | Reason | Detail |
| ---- | ------ | ------ |
| [.github](https://github.com/OCA/.github) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [ai](https://github.com/OCA/ai) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [ansible-odoo](https://github.com/OCA/ansible-odoo) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [connector-magento-php-extension](https://github.com/OCA/connector-magento-php-extension) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [connector-mautic](https://github.com/OCA/connector-mautic) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [connector-shopify](https://github.com/OCA/connector-shopify) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [cooperative](https://github.com/OCA/cooperative) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [crowdfunding](https://github.com/OCA/crowdfunding) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [edi-ediversa](https://github.com/OCA/edi-ediversa) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [edi-framework](https://github.com/OCA/edi-framework) | `no_module` | No directory with __manifest__.py at repo root |
| [edi-voxel](https://github.com/OCA/edi-voxel) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [l10n-chile](https://github.com/OCA/l10n-chile) | `no_module` | No directory with __manifest__.py at repo root |
...
| [l10n-paraguay](https://github.com/OCA/l10n-paraguay) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [mail](https://github.com/OCA/mail) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [maintainer-tools](https://github.com/OCA/maintainer-tools) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [mass-mailing](https://github.com/OCA/mass-mailing) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [mirrors-flake8](https://github.com/OCA/mirrors-flake8) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [module-composition-analysis](https://github.com/OCA/module-composition-analysis) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [oca-addons-repo-template](https://github.com/OCA/oca-addons-repo-template) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [oca-apps-store](https://github.com/OCA/oca-apps-store) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [oca-ci](https://github.com/OCA/oca-ci) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [oca-custom](https://github.com/OCA/oca-custom) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [oca-github-bot](https://github.com/OCA/oca-github-bot) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [oca-port](https://github.com/OCA/oca-port) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [oca-weblate-deployment](https://github.com/OCA/oca-weblate-deployment) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [oca.recipe.odoo](https://github.com/OCA/oca.recipe.odoo) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [odoo-community.org](https://github.com/OCA/odoo-community.org) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [odoo-module-migrator](https://github.com/OCA/odoo-module-migrator) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [odoo-pre-commit-hooks](https://github.com/OCA/odoo-pre-commit-hooks) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [odoo-sentinel](https://github.com/OCA/odoo-sentinel) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [odoo-sphinx-autodoc](https://github.com/OCA/odoo-sphinx-autodoc) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [odoo-test-helper](https://github.com/OCA/odoo-test-helper) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [odoorpc](https://github.com/OCA/odoorpc) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [openupgradelib](https://github.com/OCA/openupgradelib) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [pwa-builder](https://github.com/OCA/pwa-builder) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [py3o.template](https://github.com/OCA/py3o.template) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [pylint-odoo](https://github.com/OCA/pylint-odoo) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [pytest-odoo](https://github.com/OCA/pytest-odoo) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [repo-maintainer](https://github.com/OCA/repo-maintainer) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [repo-maintainer-conf](https://github.com/OCA/repo-maintainer-conf) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [resource](https://github.com/OCA/resource) | `no_module` | No directory with __manifest__.py at repo root |
| [rest-api](https://github.com/OCA/rest-api) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [role-policy](https://github.com/OCA/role-policy) | `no_module` | No directory with __manifest__.py at repo root |
| [route-planning](https://github.com/OCA/route-planning) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [sale-blanket](https://github.com/OCA/sale-blanket) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [sale-channel](https://github.com/OCA/sale-channel) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [sale-financial](https://github.com/OCA/sale-financial) | `no_module` | No directory with __manifest__.py at repo root |
| [sale-prebook](https://github.com/OCA/sale-prebook) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [shopfloor-app](https://github.com/OCA/shopfloor-app) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [shoppingfeed](https://github.com/OCA/shoppingfeed) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [spreadsheet](https://github.com/OCA/spreadsheet) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [stock-logistics-availability](https://github.com/OCA/stock-logistics-availability) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [stock-logistics-interfaces](https://github.com/OCA/stock-logistics-interfaces) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [stock-logistics-orderpoint](https://github.com/OCA/stock-logistics-orderpoint) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [stock-logistics-putaway](https://github.com/OCA/stock-logistics-putaway) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [stock-logistics-release-channel](https://github.com/OCA/stock-logistics-release-channel) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [stock-logistics-request](https://github.com/OCA/stock-logistics-request) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [stock-logistics-reservation](https://github.com/OCA/stock-logistics-reservation) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [stock-logistics-shopfloor](https://github.com/OCA/stock-logistics-shopfloor) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [sustainability](https://github.com/OCA/sustainability) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [tier-validation](https://github.com/OCA/tier-validation) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
| [version-control-platform](https://github.com/OCA/version-control-platform) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [vertical-cooperative-supermarket](https://github.com/OCA/vertical-cooperative-supermarket) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
...
| [wallet](https://github.com/OCA/wallet) | `no_branch` | fatal: Remote branch 15.0 not found in upstream origin |
