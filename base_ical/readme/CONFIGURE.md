...
2.  Create a iCalendar, fill in the model you want to expose and
    possibly a domain to restrict records. You can use the `user`
    variable to restrict things relative to the user using the iCalendar
