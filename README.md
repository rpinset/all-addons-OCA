...
| [account-financial-tools](https://github.com/OCA/account-financial-tools) | 45 | d5a57f3 2026-04-20 Judith Massa Translated using Weblate (German) |
| [account-fiscal-rule](https://github.com/OCA/account-fiscal-rule) | 8 | 63049df 2026-03-02 Pedro M. Baeza Merge pull request #580 from ursais/15-dr-precommit-update |
| [account-invoice-reporting](https://github.com/OCA/account-invoice-reporting) | 12 | 36b37fe 2025-07-21 Carlos Roca Zaragoza Translated using Weblate (Catalan) |
| [account-invoicing](https://github.com/OCA/account-invoicing) | 79 | 851581c 2025-12-09 mymage Translated using Weblate (Italian) |
...
| [community-data-files](https://github.com/OCA/community-data-files) | 9 | 9a9477c 2026-03-05 OCA-git-bot [BOT] post-merge updates |
| [connector](https://github.com/OCA/connector) | 6 | ffc6ba7 2025-06-04 OCA-git-bot [UPD] addons table in README.md |
...
| [contract](https://github.com/OCA/contract) | 11 | 9a61051 2025-07-01 mymage Translated using Weblate (Italian) |
| [credit-control](https://github.com/OCA/credit-control) | 9 | c5abae8 2025-08-28 OCA-git-bot [BOT] post-merge updates |
| [crm](https://github.com/OCA/crm) | 22 | ed7c3d0 2025-06-04 OCA-git-bot [UPD] addons table in README.md |
...
| [field-service](https://github.com/OCA/field-service) | 46 | 94d4f96 2026-04-13 mymage Translated using Weblate (Italian) |
| [fleet](https://github.com/OCA/fleet) | 14 | 9dff795 2025-11-10 mymage Translated using Weblate (Italian) |
| [helpdesk](https://github.com/OCA/helpdesk) | 9 | 989fe00 2026-01-26 OCA-git-bot [BOT] post-merge updates |
| [hr](https://github.com/OCA/hr) | 32 | 253de1a 2025-10-21 mymage Translated using Weblate (Italian) |
| [hr-attendance](https://github.com/OCA/hr-attendance) | 11 | 31dbaf3 2026-02-04 OCA-git-bot [BOT] post-merge updates |
| [hr-expense](https://github.com/OCA/hr-expense) | 23 | 02b359a 2025-12-20 OCA-git-bot [BOT] post-merge updates |
| [hr-holidays](https://github.com/OCA/hr-holidays) | 7 | 084b339 2025-09-26 OCA-git-bot [BOT] post-merge updates |
| [interface-git](https://github.com/OCA/interface-git) | 2 | 7bb75f2 2026-04-16 OCA-git-bot [ADD] setup.py |
| [intrastat-extrastat](https://github.com/OCA/intrastat-extrastat) | 7 | a3ace05 2025-06-04 OCA-git-bot [UPD] addons table in README.md |
| [iot](https://github.com/OCA/iot) | 7 | d4b6b4c 2025-06-21 mymage Translated using Weblate (Italian) |
| [knowledge](https://github.com/OCA/knowledge) | 11 | 2085364 2025-11-24 mymage Translated using Weblate (Italian) |
...
| [l10n-estonia](https://github.com/OCA/l10n-estonia) | 2 | 97256e8 2025-06-05 OCA-git-bot [UPD] addons table in README.md |
| [l10n-finland](https://github.com/OCA/l10n-finland) | 3 | e6b142a 2025-02-02 oca-git-bot [IMP] update dotfiles |
| [l10n-france](https://github.com/OCA/l10n-france) | 18 | 7100ac8 2026-01-20 OCA-git-bot [BOT] post-merge updates |
| [l10n-germany](https://github.com/OCA/l10n-germany) | 5 | 95c5cc9 2025-10-07 Weblate Update translation files |
| [l10n-iran](https://github.com/OCA/l10n-iran) | 1 | dfdea67 2025-02-02 oca-git-bot [IMP] update dotfiles |
| [l10n-japan](https://github.com/OCA/l10n-japan) | 3 | fbb9ae9 2025-02-02 oca-git-bot [IMP] update dotfiles |
| [l10n-mexico](https://github.com/OCA/l10n-mexico) | 2 | 7a2af28 2025-03-07 OCA-git-bot [UPD] README.rst |
...
| [l10n-spain](https://github.com/OCA/l10n-spain) | 61 | ab5b2fc 2026-02-16 Weblate Update translation files |
...
| [maintenance](https://github.com/OCA/maintenance) | 25 | 7ecd3fc 2025-10-14 Yann Papouin Added translation using Weblate (French) |
...
| [partner-contact](https://github.com/OCA/partner-contact) | 65 | c931f24 2026-02-01 Matjaz Mozetic Translated using Weblate (Slovenian) |
| [payroll](https://github.com/OCA/payroll) | 3 | 8f68f5a 2026-02-01 Matjaz Mozetic Translated using Weblate (Slovenian) |
| [pos](https://github.com/OCA/pos) | 19 | 7bf804b 2025-12-19 OCA-git-bot [BOT] post-merge updates |
| [product-attribute](https://github.com/OCA/product-attribute) | 55 | 051560e 2026-03-19 OCA-git-bot [BOT] post-merge updates |
| [product-pack](https://github.com/OCA/product-pack) | 3 | f0bba29 2025-06-04 OCA-git-bot [UPD] addons table in README.md |
| [product-variant](https://github.com/OCA/product-variant) | 5 | 0608542 2025-08-06 mymage Translated using Weblate (Italian) |
| [project](https://github.com/OCA/project) | 39 | aa7e6c3 2025-10-23 OCA-git-bot [BOT] post-merge updates |
...
| [server-auth](https://github.com/OCA/server-auth) | 20 | c31df16 2026-02-19 OCA-git-bot [BOT] post-merge updates |
| [server-backend](https://github.com/OCA/server-backend) | 10 | e604663 2026-02-12 OCA-git-bot [BOT] post-merge updates |
| [server-brand](https://github.com/OCA/server-brand) | 4 | 55b697f 2025-06-04 OCA-git-bot [UPD] addons table in README.md |
| [server-env](https://github.com/OCA/server-env) | 7 | ddfc291 2025-06-04 OCA-git-bot [UPD] addons table in README.md |
| [server-tools](https://github.com/OCA/server-tools) | 46 | a0ee8c7 2025-11-28 mymage Translated using Weblate (Italian) |
...
| [stock-logistics-warehouse](https://github.com/OCA/stock-logistics-warehouse) | 59 | 3c6420b 2026-04-03 mymage Translated using Weblate (Italian) |
| [stock-logistics-workflow](https://github.com/OCA/stock-logistics-workflow) | 79 | 5efac28 2026-02-01 Matjaz Mozetic Translated using Weblate (Slovenian) |
...
| [survey](https://github.com/OCA/survey) | 19 | 83d01bf 2025-08-11 OCA-git-bot [BOT] post-merge updates |
| [timesheet](https://github.com/OCA/timesheet) | 19 | 0223d05 2026-03-25 Pedro M. Baeza Merge pull request #890 from ForgeFlow/15.0-copier-update |
...
| [vertical-hotel](https://github.com/OCA/vertical-hotel) | 6 | 98aa4f1 2026-01-12 mymage Translated using Weblate (Italian) |
